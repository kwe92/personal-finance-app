...
export const CardHeader = ({
  ...
  onIconTap: React.MouseEventHandler;
  handleEditItem: React.MouseEventHandler;
  ...
  return (
    <div className="card-header">
      ...
      <div
        className={dropdownClassName} // required to toggle the drop down menu
        style={{
          display: "flex",
          position: "relative",
      ...
      >
        {/* dot dot dot icon */}
        <svg viewBox="0 0 14 4" onClick={onIconTap}>
        ...
        <div className="card-drop-down-menu">
          <p onClick={handleEditItem}>Edit {dropdownText}</p>
          <p style={{ color: "#C94736" }} onClick={handleDeleteItem}>
            Delete {dropdownText}
          </p>
        </div>
      </div>
